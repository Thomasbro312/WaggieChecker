...
?>
    ...
    <?php
        ...
        dd($rdw->getCarWithLicense("86TGJV")->kenteken);
    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
            ...
            <button type="button" class="btn btn-primary"><a href="{{route('car.create')}}">Maak Advert.</a></button>
        </div>
    </nav>
    </div>
    <br>
    <div class="car-grid">
        @foreach($cars as $items)
            <div class="car-plaque">
                <a href="{{route('car.show',$items['id'])}}">
